/*
  ...
  - Added the required column `tenantId` to the `CashRegister` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `tenantId` to the `ConsentDocument` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `Coupon` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `InventoryMovement` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `tenantId` to the `InvoiceItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `PackageTemplate` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `PackageTemplateLine` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `tenantId` to the `PayrollEntry` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `tenantId` to the `RetouchSchedule` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `tenantId` to the `ServiceCampaign` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `ServiceConsumable` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `SessionDetail` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `StaffProfile` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `TreatmentPackage` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tenantId` to the `TreatmentPackageLine` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Appointment" ("cabin", "createdAt", "dateTime", "duration", "id", "patientId", "professionalId", "serviceId", "status", "updatedAt") SELECT "cabin", "createdAt", "dateTime", "duration", "id", "patientId", "professionalId", "serviceId", "status", "updatedAt" FROM "Appointment";
...
INSERT INTO "new_Campaign" ("createdAt", "description", "discountType", "discountValue", "endDate", "id", "isActive", "name", "startDate", "updatedAt") SELECT "createdAt", "description", "discountType", "discountValue", "endDate", "id", "isActive", "name", "startDate", "updatedAt" FROM "Campaign";
DROP TABLE "Campaign";
...
INSERT INTO "new_CashMovement" ("amount", "cashRegisterId", "createdAt", "description", "id", "invoiceId", "type", "userId") SELECT "amount", "cashRegisterId", "createdAt", "description", "id", "invoiceId", "type", "userId" FROM "CashMovement";
...
INSERT INTO "new_CashRegister" ("actualBalance", "closedById", "closingDate", "createdAt", "discrepancy", "expectedBalance", "id", "initialBalance", "notes", "openedById", "openingDate", "status", "updatedAt") SELECT "actualBalance", "closedById", "closingDate", "createdAt", "discrepancy", "expectedBalance", "id", "initialBalance", "notes", "openedById", "openingDate", "status", "updatedAt" FROM "CashRegister";
...
INSERT INTO "new_Commission" ("amount", "appointmentId", "createdAt", "id", "payrollId", "staffId", "status", "updatedAt") SELECT "amount", "appointmentId", "createdAt", "id", "payrollId", "staffId", "status", "updatedAt" FROM "Commission";
...
INSERT INTO "new_ConsentDocument" ("id", "patientId", "serviceId", "signatureData", "signedAt") SELECT "id", "patientId", "serviceId", "signatureData", "signedAt" FROM "ConsentDocument";
...
INSERT INTO "new_Coupon" ("code", "createdAt", "description", "discountType", "discountValue", "endDate", "id", "isActive", "maxUses", "minSubtotal", "startDate", "updatedAt", "usedCount") SELECT "code", "createdAt", "description", "discountType", "discountValue", "endDate", "id", "isActive", "maxUses", "minSubtotal", "startDate", "updatedAt", "usedCount" FROM "Coupon";
DROP TABLE "Coupon";
...
INSERT INTO "new_InventoryMovement" ("appointmentId", "createdAt", "id", "notes", "productId", "quantity", "type") SELECT "appointmentId", "createdAt", "id", "notes", "productId", "quantity", "type" FROM "InventoryMovement";
...
INSERT INTO "new_Invoice" ("appointmentId", "couponId", "createdAt", "id", "paidAt", "patientId", "paymentMethod", "reference", "status", "subtotal", "tax", "total", "updatedAt") SELECT "appointmentId", "couponId", "createdAt", "id", "paidAt", "patientId", "paymentMethod", "reference", "status", "subtotal", "tax", "total", "updatedAt" FROM "Invoice";
DROP TABLE "Invoice";
...
INSERT INTO "new_InvoiceItem" ("createdAt", "description", "id", "invoiceId", "productId", "quantity", "total", "unitPrice") SELECT "createdAt", "description", "id", "invoiceId", "productId", "quantity", "total", "unitPrice" FROM "InvoiceItem";
...
INSERT INTO "new_PackageTemplate" ("createdAt", "description", "id", "isActive", "name", "totalPrice", "updatedAt", "validityDays") SELECT "createdAt", "description", "id", "isActive", "name", "totalPrice", "updatedAt", "validityDays" FROM "PackageTemplate";
...
INSERT INTO "new_PackageTemplateLine" ("createdAt", "id", "serviceId", "sessions", "templateId", "updatedAt") SELECT "createdAt", "id", "serviceId", "sessions", "templateId", "updatedAt" FROM "PackageTemplateLine";
...
INSERT INTO "new_Patient" ("consentSigned", "createdAt", "email", "fullName", "id", "isActive", "medicalHistory", "phone", "updatedAt") SELECT "consentSigned", "createdAt", "email", "fullName", "id", "isActive", "medicalHistory", "phone", "updatedAt" FROM "Patient";
DROP TABLE "Patient";
...
INSERT INTO "new_PayrollEntry" ("baseSalary", "commissionsAmount", "createdAt", "id", "paidAt", "periodEnd", "periodStart", "staffId", "status", "totalPaid", "updatedAt") SELECT "baseSalary", "commissionsAmount", "createdAt", "id", "paidAt", "periodEnd", "periodStart", "staffId", "status", "totalPaid", "updatedAt" FROM "PayrollEntry";
...
INSERT INTO "new_Product" ("category", "createdAt", "id", "isActive", "name", "price", "stock", "unit", "updatedAt") SELECT "category", "createdAt", "id", "isActive", "name", "price", "stock", "unit", "updatedAt" FROM "Product";
DROP TABLE "Product";
...
INSERT INTO "new_RetouchSchedule" ("createdAt", "id", "notes", "originalAppointmentId", "patientId", "retouchAppointmentId", "retouchNumber", "scheduledDate", "serviceId", "status", "updatedAt") SELECT "createdAt", "id", "notes", "originalAppointmentId", "patientId", "retouchAppointmentId", "retouchNumber", "scheduledDate", "serviceId", "status", "updatedAt" FROM "RetouchSchedule";
...
INSERT INTO "new_Service" ("category", "contraindications", "createdAt", "defaultDuration", "defaultPrice", "id", "isActive", "name", "requiresConsent", "retouchConfig", "treatmentType", "updatedAt") SELECT "category", "contraindications", "createdAt", "defaultDuration", "defaultPrice", "id", "isActive", "name", "requiresConsent", "retouchConfig", "treatmentType", "updatedAt" FROM "Service";
DROP TABLE "Service";
...
INSERT INTO "new_ServiceCampaign" ("campaignId", "createdAt", "id", "serviceId", "updatedAt") SELECT "campaignId", "createdAt", "id", "serviceId", "updatedAt" FROM "ServiceCampaign";
...
INSERT INTO "new_ServiceConsumable" ("createdAt", "id", "productId", "quantity", "serviceId", "updatedAt") SELECT "createdAt", "id", "productId", "quantity", "serviceId", "updatedAt" FROM "ServiceConsumable";
...
INSERT INTO "new_SessionDetail" ("appointmentId", "createdAt", "evolutionNotes", "id", "measurements", "packageLineId", "updatedAt") SELECT "appointmentId", "createdAt", "evolutionNotes", "id", "measurements", "packageLineId", "updatedAt" FROM "SessionDetail";
...
INSERT INTO "new_StaffProfile" ("baseSalary", "commissionRate", "createdAt", "id", "salesTarget", "updatedAt", "userId") SELECT "baseSalary", "commissionRate", "createdAt", "id", "salesTarget", "updatedAt", "userId" FROM "StaffProfile";
...
INSERT INTO "new_TreatmentPackage" ("createdAt", "expiresAt", "id", "packageName", "patientId", "purchasedAt", "status", "updatedAt") SELECT "createdAt", "expiresAt", "id", "packageName", "patientId", "purchasedAt", "status", "updatedAt" FROM "TreatmentPackage";
...
INSERT INTO "new_TreatmentPackageLine" ("createdAt", "id", "packageId", "serviceId", "serviceName", "totalSessions", "updatedAt", "usedSessions") SELECT "createdAt", "id", "packageId", "serviceId", "serviceName", "totalSessions", "updatedAt", "usedSessions" FROM "TreatmentPackageLine";
...
INSERT INTO "new_User" ("createdAt", "email", "id", "isActive", "name", "password", "role", "updatedAt", "workingHours") SELECT "createdAt", "email", "id", "isActive", "name", "password", "role", "updatedAt", "workingHours" FROM "User";
DROP TABLE "User";
