...
async function main() {
  ...
  await prisma.consentDocument.upsert({
    ...
    create: {
      ...
      patientId: patSofia.id,
      serviceId: 'seed-srv-microblading',
      signatureData: 'data:image/png;base64,sofia_signature_placeholder',
      signedAt: daysAgo(15),
      tenantId: tenant.id,
    },
  });
  ...
  await prisma.consentDocument.upsert({
    ...
    create: {
      ...
      patientId: patMaria.id,
      serviceId: 'seed-srv-cavitacion',
      signatureData: 'data:image/png;base64,maria_signature_placeholder',
      signedAt: daysAgo(21),
      tenantId: tenant.id,
    },
  });
  ...
  await prisma.consentDocument.upsert({
    ...
    create: {
      ...
      patientId: patAna.id,
      serviceId: 'seed-srv-radiofrecuencia',
      signatureData: 'data:image/png;base64,ana_signature_placeholder',
      signedAt: daysAgo(14),
      tenantId: tenant.id,
    },
  });
  ...
  await prisma.consentDocument.upsert({
    ...
    create: {
      ...
      patientId: patCarmen.id,
      serviceId: 'seed-srv-peeling',
      signatureData: 'data:image/png;base64,carmen_signature_placeholder',
      signedAt: daysAgo(21),
      tenantId: tenant.id,
    },
  });
  ...
  await prisma.consentDocument.upsert({
    ...
    create: {
      ...
      patientId: patFernando.id,
      serviceId: 'seed-srv-microblading',
      signatureData: 'data:image/png;base64,fernando_signature_placeholder',
      signedAt: daysAgo(10),
      tenantId: tenant.id,
    },
  });
